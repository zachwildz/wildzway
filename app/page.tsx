  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, overflow: "hidden", background: "#000" }}>
      ...
      {stars.current.map((star, i) => (
        <div key={i} style={{ position: "absolute", left: star.x + "%", top: star.y + "%", width: 2, height: 2, background: "#fff", borderRadius: "50%", opacity: 0, animation: "twinkle " + star.duration + "s " + star.delay + "s infinite", "--peak-opacity": star.peakOpacity }} />
      ))}
      <style>{`
...
function HomePage({ setPage }) {
  ...
  const projects = [
    {
      title: "Brinkline",
      desc: "Digital infrastructure and execution systems designed to modernize businesses and communities.",
      page: PAGES.wayz,
      accent: "#22d3ee",
    },
    {
      title: "Polaroid Fever",
      desc: "A cultural artifact exploring sound, aesthetic, and narrative identity.",
      page: PAGES.wonderz,
      accent: "#d946ef",
    },
    {
      title: "Field Guide",
      desc: "A personal operating system designed to structure growth, belief, and strategic life mapping.",
      page: PAGES.worldz,
      accent: "#34d399",
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Building{" "}
              <GradientText>Worldz</GradientText>.{" "}
              <br />
            ...
            <div style={{ display: "flex", gap: 14, marginTop: 40, flexWrap: "wrap" }}>
              ...
              <Button variant="ghost" onClick={() => setPage(PAGES.worldz)}>
                View Projects →
              </Button>
            </div>
          </div>
            ...
            >
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "conic-gradient(from 180deg at 50% 50%, rgba(52,211,153,0.12) 0deg, rgba(34,211,238,0.10) 90deg, rgba(168,85,247,0.12) 180deg, rgba(217,70,239,0.08) 270deg, rgba(52,211,153,0.12) 360deg)",
      ...
      <Section style={{ padding: "60px clamp(24px, 5vw, 80px) 120px", maxWidth: 1280, margin: "0 auto" }}>
        <div
          style={{
            ...
            textAlign: "center",
            background:
              "linear-gradient(135deg, rgba(34,211,238,0.08) 0%, rgba(168,85,247,0.06) 50%, rgba(217,70,239,0.04) 100%)",
        ...
        >
          ...
          >
            Let's create systems that last and artifacts that matter.
          </p>
          <Button onClick={() => setPage(PAGES.contact)} style={{ position: "relative" }}>
      ...
      >
        <div
          style={{
            ...
            height: 4,
            borderRadius: 2,
            background: accentColor || "linear-gradient(90deg, #22d3ee, #a855f7)",
            marginBottom: 28,
          }}
        />
        <h1
      ...
      sections={[
        {
          label: "Framework",
          title: "Field Guide",
          desc: "A personal operating system for structuring growth, belief systems, and strategic life mapping. Built for clarity in complexity.",
        },
        {
          label: "System",
          title: "LoopStack",
          desc: "Modular system architecture for building feedback loops, decision engines, and structured iteration cycles at scale.",
        },
        {
          label: "Philosophy",
          title: "Infrastructure Thinking",
          desc: "Every great output needs a backbone. We design invisible systems that make visible results inevitable.",
        },
        {
          label: "Vision",
          title: "Long-Term Horizon",
          desc: "WildzWay builds for decades, not quarters. Our systems are designed to compound, evolve, and endure.",
        },
      ]}
    />
  );
      ...
      sections={[
        {
          label: "Artifact",
          title: "Polaroid Fever",
          desc: "An exploration of sound, aesthetic, and narrative identity. A cultural artifact that blends music, visuals, and storytelling.",
        },
        {
          label: "Pipeline",
          title: "Future Drops",
          desc: "Upcoming creative releases across music, media, and digital experiences. Every drop is engineered with intention.",
        },
        {
          label: "Lab",
          title: "Media & Concepts",
          desc: "Experimental creative work spanning video, design, generative art, and narrative world-building.",
        },
        {
          label: "Archive",
          title: "Creative Vault",
          desc: "A living archive of works in progress, research material, and creative prototypes from the studio.",
        },
      ]}
    />
  );
      ...
      sections={[
        {
          label: "Platform",
          title: "Brinkline",
          desc: "Digital infrastructure and execution systems designed to modernize businesses, communities, and service delivery.",
        },
        {
          label: "Services",
          title: "Studio Services",
          desc: "End-to-end digital strategy, design, and development. From concept to deployed, production-grade systems.",
        },
        {
          label: "Capabilities",
          title: "Technical Stack",
          desc: "Full-stack engineering, systems design, product architecture, and scalable deployment across modern platforms.",
        },
        {
          label: "Process",
          title: "Strategy & Build",
          desc: "Our process: discover, define, design, build, ship, iterate. Every engagement follows a structured execution path.",
        },
      ]}
    />
  );
...
function WayfinderPage() {
  ...
  const suggestions = [
    "Tell me about WildzWay",
    "What is Brinkline?",
    "Explain the Field Guide",
  ...
  return (
    ...
    >
      {/* Particle network — only on this page */}
      <ParticleNetwork />
      {/* Hero / Empty state */}
      {!hasMessages && (
        <div
        ...
        >
          ...
          >
            Wayfinder is your guide to the WildzWay studio — ask about projects, systems, or ideas.
          </p>
      ...
      {hasMessages && (
        <div
          style={{
            flex: 1,
            overflowY: "auto",
            padding: "100px clamp(16px, 4vw, 60px) 24px",
            maxWidth: 760,
            margin: "0 auto",
            width: "100%",
          }}
            ...
            >
              <div
                style={{
                  ...
                  border: `1px solid ${msg.role === "user" ? "rgba(34,211,238,0.15)" : "rgba(255,255,255,0.06)"}`,
                  backdropFilter: "blur(20px)",
                }}
              >
                {msg.role === "assistant" && (
                  ...
                  {[0, 1, 2].map((d) => (
                    <div
                      ...
                      style={{
                        ...
                        animation: `dotPulse 1.4s ${d * 0.2}s ease-in-out infinite`,
                      }}
                    />
                  ))}
                </div>
      ...
      <div
        style={{
          ...
          bottom: 0,
          padding: "16px clamp(16px, 4vw, 60px) 32px",
          maxWidth: 760,
          margin: "0 auto",
          width: "100%",
        }}
      >
        <div
          style={{
            ...
            border: "1px solid rgba(255,255,255,0.08)",
            backdropFilter: "blur(20px)",
            boxShadow: "0 0 0 1px rgba(255,255,255,0.05), 0 4px 30px rgba(0,0,0,0.4)",
          }}
        >
          <textarea
            ref={textareaRef}
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: input.trim() && !isLoading ? "#0b0f1a" : "rgba(255,255,255,0.25)",
                border: "none",
                cursor: input.trim() && !isLoading ? "pointer" : "not-allowed",
                transition: "all 0.25s ease",
                boxShadow: input.trim() && !isLoading ? "0 0 24px rgba(34,211,238,0.2)" : "none",
              }}
            >
              Send
...
// ─── Wondervision Page (AI Art Generator) ────────────────────────
function WondervisionPage() {
  ...
  useEffect(() => {
    ...
    const texts = mode === "image"
      ? ["Interpreting your vision...", "Composing elements...", "Rendering final output..."]
      : mode === "video"
      ? ["Generating frames...", "Applying motion...", "Rendering video..."]
    ...
    const progInt = setInterval(() => {
      setProgress(p => { if (p >= 100) return 100; return p + (mode === "image" ? 1.5 : 0.8); });
    }, 30);
  ...
  const handleGenerate = async () => {
    ...
    try {
      // Use Claude to generate a description of what the image would look like
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  const modes = [
    ...
    { id: "avatar", label: "3D Avatar", icon: "🧊" },
  ];

  const styles = ["artistic", "professional", "cinematic", "vintage", "anime", "photorealistic"];
  const resolutions = mode === "video"
    ? ["512x512", "1024x576", "1280x720"]
    : ["512x512", "768x768", "1024x1024", "1536x1536"];

  const suggestions = mode === "image"
    ? ["Cosmic cityscape at sunset with aurora skies", "Abstract neural network visualization", "Futuristic studio workspace floating in space"]
    : mode === "video"
    ? ["Camera orbiting a glowing crystal structure", "Timelapse of a digital city being built", "Flowing aurora particles in slow motion"]
    ...
    <div style={{ position: "relative", zIndex: 1, minHeight: "100vh", opacity: loaded ? 1 : 0, transform: loaded ? "translateY(0)" : "translateY(20px)", transition: "all 0.8s cubic-bezier(0.16, 1, 0.3, 1)" }}>
      <div style={{ padding: "120px clamp(16px, 4vw, 60px) 60px", maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <h1 style={{ fontSize: "clamp(32px, 4vw, 52px)", fontWeight: 800, color: "#fff", margin: "0 0 12px", fontFamily: "'Outfit', sans-serif" }}>
            Wonder<GradientText>vision</GradientText>
          </h1>
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif" }}>
            Generate images, videos, and 3D avatars with AI
          </p>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 8, marginBottom: 32 }}>
          {modes.map(m => (
            <button key={m.id} onClick={() => setMode(m.id)} style={{
              ...
              borderColor: mode === m.id ? "rgba(217,70,239,0.3)" : "rgba(255,255,255,0.08)",
              background: mode === m.id ? "rgba(217,70,239,0.1)" : "rgba(255,255,255,0.03)",
              color: mode === m.id ? "#d946ef" : "rgba(255,255,255,0.5)",
        ...
        <GlassCard hoverGlow={false} style={{ padding: "32px 28px" }}>
          ...
          <div style={{ marginBottom: 20 }}>
            <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "rgba(255,255,255,0.4)", marginBottom: 8, letterSpacing: "0.06em", fontFamily: "'Outfit', sans-serif" }}>
            ...
            <textarea
              ...
              style={{
                width: "100%", minHeight: 80, resize: "vertical", padding: "14px 16px", borderRadius: 14,
                border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.04)",
                color: "#fff", fontSize: 15, fontFamily: "'Outfit', sans-serif", outline: "none", boxSizing: "border-box", lineHeight: 1.5,
              }}
            />
          </div>
          ...
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 24 }}>
            {suggestions.map(s => (
              ...
              onMouseEnter={e => { e.target.style.color = "rgba(255,255,255,0.7)"; e.target.style.borderColor = "rgba(255,255,255,0.12)"; }}
          ...
          <Button
            ...
            style={{ width: "100%", background: isGenerating ? "rgba(255,255,255,0.06)" : undefined, cursor: isGenerating ? "not-allowed" : undefined }}
          >
          ...
          {isGenerating && (
            <div style={{ marginTop: 24, textAlign: "center" }}>
              <p style={{ fontSize: 14, color: "rgba(255,255,255,0.5)", fontFamily: "'Outfit', sans-serif", marginBottom: 12 }}>
                {loadingText}
              </p>
            ...
            <div style={{ marginTop: 28 }}>
              <div style={{ padding: 24, borderRadius: 16, background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.06)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                  <div style={{ width: 8, height: 8, borderRadius: "50%", background: generatedUrl.error ? "#ef4444" : "#34d399", boxShadow: generatedUrl.error ? "0 0 8px rgba(239,68,68,0.4)" : "0 0 8px rgba(52,211,153,0.4)" }} />
                  <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", color: generatedUrl.error ? "#ef4444" : "#34d399", fontFamily: "'Outfit', sans-serif" }}>
                    {generatedUrl.error ? "Error" : "Generation Complete"}
                  </span>
                </div>
                <p style={{ fontSize: 15, color: "rgba(255,255,255,0.6)", lineHeight: 1.7, fontFamily: "'Outfit', sans-serif" }}>
                  {generatedUrl.description}
                </p>
                {!generatedUrl.error && (
                  <div style={{ display: "flex", gap: 12, marginTop: 16, flexWrap: "wrap" }}>
                    <div style={{ padding: "6px 14px", borderRadius: 100, fontSize: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif" }}>
                      {generatedUrl.style}
                    </div>
                    <div style={{ padding: "6px 14px", borderRadius: 100, fontSize: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif" }}>
                      {generatedUrl.resolution}
                    </div>
                    <div style={{ padding: "6px 14px", borderRadius: 100, fontSize: 12, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.06)", color: "rgba(255,255,255,0.4)", fontFamily: "'Outfit', sans-serif" }}>
                      {generatedUrl.type}
                    </div>
        ...
        {history.length > 0 && (
          <Section style={{ marginTop: 40 }}>
            <p style={{ fontSize: 13, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.3)", marginBottom: 16, fontFamily: "'Outfit', sans-serif" }}>
              Recent Generations
            </p>
      ...
      <style>{`
        @media (max-width: 600px) {
          .wv-settings { grid-template-columns: 1fr !important; }
        }
      ...
      >
        ...
        <Section>
          <GlassCard hoverGlow={false}>
            ...
            >
              Mission-driven builder operating at the intersection of creative vision and technical execution. Focused on building systems, artifacts, and frameworks that compound over time.
            </p>
          </GlassCard>
        </Section>
    ...
    <div style={{ position: "relative", zIndex: 1 }}>
      ...
      >
        ...
        <GlassCard hoverGlow={false} style={{ padding: "40px 36px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div>
              ...
              <input
                style={inputStyle}
                placeholder="e.g. Brand, Platform, Creative, Infrastructure"
        ...
        >
          ...
          <span style={{ color: "#22d3ee" }}>hello@wildzway.com</span>
        </p>
      </div>
    </div>
  );
